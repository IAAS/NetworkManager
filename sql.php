...
define("SQL_CREATE_DATABASE_DESCRIPTIONS", json_encode(array(
	...
	"create foreign key on SSHKey table"
)));
define("SQL_CREATE_DATABASE_COMMANDS", json_encode(array(
	...
	"CREATE TABLE SSHKey (id int(10) unsigned NOT NULL AUTO_INCREMENT, keyData TEXT, keyType varchar(5), fingerprint varchar(47), Login_id int(10) unsigned, PRIMARY KEY (id), UNIQUE INDEX (id));",
	...
	"ALTER TABLE SSHKey ADD INDEX FKKey890017 (Login_id), ADD CONSTRAINT FKKey890017 FOREIGN KEY (Login_id) REFERENCES Login (id);"
)));

define("SQL_CLEAR_DATABASE_DESCRIPTIONS", json_encode(array(
	"drop foreign key on Pool table",
	"drop foreign key on Pool table",
	"drop foreign key on Address table",
	"drop foreign key on Login table",
	"drop foreign key on SSHKey table",
	"drop table Address",
	"drop table Computer",
	"drop table SSHKey",
	"drop table Login",
...
define("SQL_CLEAR_DATABASE_COMMANDS", json_encode(array(
	...
	"ALTER TABLE SSHKey DROP FOREIGN KEY FKKey890017;",
